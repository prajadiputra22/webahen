    ...
    <nav class="bg-white shadow-md transition-all duration-300" 
         :class="{'fixed top-0 left-0 right-0 z-50 transform translate-y-0': showNavbar, 'fixed top-0 left-0 right-0 z-50 transform -translate-y-full': !showNavbar}"
         x-data="{isOpen: false}">
      <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div class="flex h-16 items-center justify-between">
          ...
          <div class="hidden md:flex items-center space-x-4">
            <a href="https://www.facebook.com/profile.php?id=61575351231690&locale=id_ID" class="text-gray-950 hover:text-gray-900">
              <i class="fab fa-facebook-f"></i>
            </a>
            <a href="https://www.instagram.com/sugarahen_/" class="text-gray-950 hover:text-gray-900">
              <i class="fab fa-instagram"></i>
            </a>
            <a href="#" class="text-gray-950 hover:text-gray-900">
          ...
          <div class="-mr-2 flex md:hidden">
            ...
            <button type="button" @click="isOpen = !isOpen"
                class="relative inline-flex items-center justify-center rounded-md bg-white p-2 text-gray-700 hover:bg-gray-100 hover:text-gray-900 focus:ring-2 focus:ring-gray-500 focus:ring-offset-2 focus:outline-hidden" aria-controls="mobile-menu" aria-expanded="false">
