   <!-- Static Hero Section -->
   <div class="relative bg-amber-400 h-[100vh] overflow-hidden pt-16">
    ...
    <!-- Content -->
    <div class="relative z-10 flex items-center h-full pt-4">
      <div class="container mx-auto px-6 md:px-12">
        <div class="max-w-2xl">
          ...
          <div class="max-w-sm">
            <p class="text-2xl text-white mt-6 overflow-hidden text-ellipsis" style="display: -webkit-box; -webkit-line-clamp: 4; -webkit-box-orient: vertical;">
              Made from high quality genuine Indonesian palm sap, it produces natural sugar that is good for the body.
            </p>
          </div>
          <div class="mt-8">
