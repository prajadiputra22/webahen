...
@section('content')
    <div class="bg-white rounded-lg shadow-md p-6">
        <div class="flex justify-between items-center mb-6">
            ...
            <a href="{{ route('admin.posts.create') }}" class="bg-amber-500 hover:bg-amber-600 text-white font-bold py-2 px-4 rounded">
        ...
        @if($posts->count())
            <div class="overflow-x-auto">
                <table class="min-w-full bg-white">
                    <thead>
                        <tr>
                            <th class="py-3 px-4 bg-gray-100 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Title</th>
                            <th class="py-3 px-4 bg-gray-100 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Author</th>
                        ...
                        @foreach($posts as $post)
                            <tr>
                                <td class="py-4 px-4 whitespace-nowrap">
                                    <div class="text-sm font-medium text-gray-900">{{ $post->tittle }}</div>
                                ...
                                <td class="py-4 px-4 whitespace-nowrap text-sm font-medium">
                                    <div class="flex space-x-2">
                                        ...
                                        <a href="/posts/{{ $post->slug }}" target="_blank" class="text-green-600 hover:text-green-900">
        ...
        @else
            <div class="text-center py-8">
                ...
                <a href="{{ route('admin.posts.create') }}" class="mt-4 inline-block bg-amber-500 hover:bg-amber-600 text-white font-bold py-2 px-4 rounded">
                    <i class="fas fa-plus mr-2"></i> Add New Post
                </a>
            </div>
        @endif
